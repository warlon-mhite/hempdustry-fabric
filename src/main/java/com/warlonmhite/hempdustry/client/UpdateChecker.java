...
public final class UpdateChecker {
    ...
    /**
      ...
      *
      * <p>{@code getName()} here and {@code name()} from 1.21.5 on — the one place this file differs
      * from its 1.21.11 twin besides the two text events above. Read from the game either way: a
      * literal here is what had the checker asking for the wrong version through the whole port.
      */
