 ...
 */
public final class InfuserPourGameTest {
    ...
    public static void milkIsPouredInByHand(TestContext context) {
     ...
     */
    public static void dispenserPoursMilkAndKeepsTheBucket(TestContext context) {
        context.setBlockState(TUB, ModBlocks.INFUSER);
     ...
     */
    public static void retiredSlotsHandBackTheirItems(TestContext context) {
        context.setBlockState(TUB, ModBlocks.INFUSER);
        InfuserBlockEntity infuser = context.getBlockEntity(TUB, InfuserBlockEntity.class);
