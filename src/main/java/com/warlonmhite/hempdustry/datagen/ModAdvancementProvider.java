    ...
    public void generateAdvancement(RegistryWrapper.WrapperLookup registryLookup, Consumer<AdvancementEntry> consumer) {
        ...
        Advancement.Builder.create()
                ...
                .criterion("ate_a_hemp_seed_food", ConsumeItemCriterion.Conditions.predicate(
                        ItemPredicate.Builder.create().tag(ModTags.Items.HEMP_SEED_FOODS)))
                .parent(rootAdvancement)
        ...
        Advancement.Builder.create()
                ...
                .criterion("drank_bhang", ConsumeItemCriterion.Conditions.item(ModItems.BHANG_BUCKET))
        ...
        Advancement.Builder.create()
                ...
                .criterion("ate_dawamesk", ConsumeItemCriterion.Conditions.item(ModItems.DAWAMESK))
                .parent(cannabutter)
