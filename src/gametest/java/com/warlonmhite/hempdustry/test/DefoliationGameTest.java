 ...
 */
public final class DefoliationGameTest implements FabricGameTest {
    ...
    public void freshlyPlantedCropIsUntrimmed(TestContext context) {
    ...
    @GameTest(templateName = FabricGameTest.EMPTY_STRUCTURE, tickLimit = 200)
    public void trimSurvivesGrowthToMaturity(TestContext context) {
        context.setBlockState(SOIL, Blocks.FARMLAND);
        context.setBlockState(CROP, ModBlocks.INDICA_CROP.getDefaultState()
     ...
     */
    @GameTest(templateName = FabricGameTest.EMPTY_STRUCTURE, tickLimit = 200)
    public void everyLeafTakenComesOffTheHarvest(TestContext context) {
    ...
    private static void checkHarvest(TestContext context, ServerWorld world, Vec3d origin,
        ...
        LootTable table = world.getServer().getReloadableRegistries()
                .getLootTable(mature.getBlock().getLootTableKey());
